        ...
        data.forEach(asset => {
          ...
          <td><p class="text-ligther">${asset.detail}</p></td>`
            if (asset.asset_status == 0) {
              content += `<td class="text-center"><button class="btn btn-danger br-btn" disabled>Disable</button></td></tr>`;
            }
            else if (asset.asset_status == 1) {
              content += `<td class="text-center"><button class="btn btn-success br-btn" disabled>Enable</button></td></tr>`;
            }
            else {
